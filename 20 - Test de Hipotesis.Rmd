...
La siguiente tabla es un resumen acerca de los tipos básicos de pruebas de hipótesis. Con esta tabla podrá realizar la mayoría de las pruebas de hipótesis para variables cuantitativas. Fué tomada de: <http://>

Nótese que no diferencia entre población y muestra, sólo muestra el aspecto matemático de la diferencia indicando el desvío estandat como sigma o S. Las pruebas sobre la población usan una distribución Z, que la Normal estandarizada. En cambio las pruebas sobre la muestra usan una distribución T de Student.

...
indicesDiamonds <- diamondsTidy %>% 
  ...
  reframe(n = n(), media = mean(valor), moda = moda(valor), q1 = q1(valor), mediana = median(valor),q3 = q3(valor), sd = sd(valor), varianza = var(valor), cv = sd/media, EE = std.error(valor), asimetria = skewness(valor), curtosis = kurtosis(valor), "IC95-" = ic95(valor)[1], "IC95+" = ic95(valor)[2])
indicesDiamonds
```

...
a/c = es el odds de los "Fumadores". Esto dice cuantos casos de ACV hay respecto de los casos que no tienen ACV dentro de los "Fumadores" Cuanto payor proporción de ACV, mayor es este número. Si el valor es 0.5 significa que hay tantos casos positivos de ACV como negativos.
...
Si este ejercicio se hace con las probabilidades en lugar de los odds, entonces el equivalente al OR lo llamanos "Riesgo Relativo". El OR puede variar entre 0 e infinito, mientras que el Riesgo Relativo varía entre 0 y 1, siendo 0.5 el mismo riesgo entre los dos grupos.

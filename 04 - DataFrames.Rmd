...
`Nota para Rafa: Este notebook debo mejorarlo, hay que agregarle otras formas de crear y alimentar tibbles. Por ejemplo, crear un tibble vacío y llenarlo de información usando bucles.`
...
Pipe significa cañería. Es como si a medida que los datos pasan por una cañería les vamos haciendo cosas, de modo que lo que hacemos en una etapa transforma lo que llegó por la cañería y sigue camino por la cañería que lo sigue transformado en la siguiente etapa.
